...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.contact_info'
        db.add_column(u'blog_profile', 'contact_info',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding field 'Profile.contact_phone'
        db.add_column(u'blog_profile', 'contact_phone',
                      self.gf('django.db.models.fields.CharField')(default='empty', max_length=255),
                      keep_default=False)

        # Adding field 'Profile.contact_email'
        db.add_column(u'blog_profile', 'contact_email',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.contact_info'
        db.delete_column(u'blog_profile', 'contact_info')

        # Deleting field 'Profile.contact_phone'
        db.delete_column(u'blog_profile', 'contact_phone')

        # Deleting field 'Profile.contact_email'
        db.delete_column(u'blog_profile', 'contact_email')
