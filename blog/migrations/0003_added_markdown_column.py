...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.markdown_description'
        db.add_column(u'blog_profile', 'markdown_description',
                      self.gf('django.db.models.fields.TextField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.markdown_description'
        db.delete_column(u'blog_profile', 'markdown_description')
    ...
    models = {
        ...
        u'blog.profile': {
            ...
            'markdown_description': ('django.db.models.fields.TextField', [], {}),
