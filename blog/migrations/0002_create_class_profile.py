...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'blog_profile', (
            ...
            ('username', self.gf('django.db.models.fields.related.ForeignKey')(related_name='profile', to=orm['auth.User'])),
    ...
    models = {
        ...
        u'blog.profile': {
            ...
            'username': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'profile'", 'to': u"orm['auth.User']"})
        },
